...
var PS_score = 1000, CN_score = 430, th_score = 200, jp_score = 150, CU_score = 250, hk_score = 100, sg_score = 500, br_score = 280, tw_score=590, KH_score=319, sr_score = 300; 
...
setInterval(startCountPS, 1);

function startCountPS(){
    PS_score++;
    document.getElementById("table").rows[1].cells.item(3).innerHTML = PS_score;
}

setInterval(startCountCN, 20);

function startCountCN(){
    CN_score++;
    document.getElementById("table").rows[2].cells.item(3).innerHTML = CN_score;
}
